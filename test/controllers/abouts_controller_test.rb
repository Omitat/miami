...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { gallery: @about.gallery, imgMain: @about.imgMain, text: @about.text } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { gallery: @about.gallery, imgMain: @about.imgMain, text: @about.text } }
